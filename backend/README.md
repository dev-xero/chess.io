...
you should be able to view the autogenerated swagger html file at `/api/v1/swagger/`.

note, you may have to use swag format and init every time you modify the swag comments.
